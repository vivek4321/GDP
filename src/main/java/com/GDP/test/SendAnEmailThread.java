...
public class SendAnEmailThread implements Runnable{

	String mailID;
	String firstName;
	String token;
	
	public SendAnEmailThread(String mailID, String token, String firstName) {
		super();
		this.mailID = mailID;
		this.token = token;
...
"                            <td class=\"padded\" style=\"padding: 0;vertical-align: top;padding-left: 60px;padding-right: 60px;word-break: break-word;word-wrap: break-word;\">\n" +
"                              \n" +
"            <p class=\"size-11\" style=\"font-style: normal;font-weight: 400;Margin-bottom: 24px;Margin-top: 0;font-size: 11px;line-height: 19px;font-family: Cabin,Avenir,sans-serif;color: #8f8c8f;\"><span style=\"color:#ffffff\">You're receiving this email because you recently created a new Online Document Submission System account. If this wasn't you, Please ignore this email.</span></p>\n" +
"          \n" +
"                            </td>\n" +
"                          </tr>\n" +
"                        </tbody></table>\n" +
