...
<div id="page" class="container white" style="margin-bottom: 15px; margin-top: 15px; border: solid #444; border-radius: 5px;">
          <img src="resources/img/Banner.png" class="img-responsive img-rounded imgBanner" alt="Banner"/></div>
<div id="page" class="container white" style="margin-bottom: 15px; margin-top: 15px; border: solid #444; border-radius: 5px;">
 
 <center>  <br/><br/><a href="allcharts.jsp"  
										>Allcharts</a> |
                      <a href="myanalysis_piec.jsp"  
										>Piechart</a> | <a href="myanalysis_barchart.jsp"  
										>Histo gram</a> | <a href="myanalisis_papers_users.jsp" 
										>Bar chart</a> | <a href="myanalysis_line.jsp" 
										>Line chart</a>
									<br/><br/>	
										</center>
