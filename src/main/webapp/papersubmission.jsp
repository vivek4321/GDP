...
<div id="page" class="container white" style="margin-bottom: 15px; margin-top: 15px; border: solid #444; border-radius: 5px;">
 ...
 -->
                                ...
                                <div class="form-group" id="updatestuff">
                                    ...
                                    <div class=' col-md-5' >
                                        <input id="newVersionUpload"  name="newVersionUpload" type='file' class="form-control"  required/>
                                    </div>
                                </div>
                                ...
                                <div id= "modifystuff" class="form-group">
                                    ...
                                    <div class=' col-md-5' >
                                        <input id='modifyTitle' name="paperTitle" type='text' class="form-control" required/> <br>
                                    </div>
...
$(document).ready(function () {
	...
	$.ajax({
		...
		//url : "http://odss-bearcatnetwork.rhcloud.com/TestGDP/authoreventslist/"+u1,
	...
	/***********************************Feedback Viewing*************************/
		...
		$.ajax({
			...
			success : function(data) {
				...
				/* $.each(data, function () {
					console.log(this.reviewerFeedback);
				...
				/* $.each(data, function () {								
					...
					alert(tempPaperFeedID);
					alert(tempPaperFeedID.indexOf(this.paperFeedbackID)>-1)
					if(tempPaperFeedID.indexOf(this.paperFeedbackID)>-1){
						tempPaperFeedID += "+"+this.paperFeedbackID;
